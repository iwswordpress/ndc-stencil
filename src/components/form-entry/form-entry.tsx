        ...
        <form onSubmit={(e) => this.handleSubmit(e)}>
          ...
          <div>
            <select onInput={(event) => this.handleSelect(event)}>
              ...
              <option
                value="mercedes"
                selected={this.selectValue === "mercedes"}
              >
                Mercedes
              </option>
            ...
            <select onInput={(event) => this.handleSecondSelect(event)}>
              {this.avOptions.map((recipient) => (
                <option
                  value={recipient.id}
                  selected={
                    this.selectedReceiverIds.indexOf(recipient.id) !== -1
                  }
                >
                  {recipient.name}
                </option>
          ...
          <div class="checkbox">
            <input
              ...
              id="cb1"
              name="cb1"
              onInput={(event) => this.handleCheckbox(event)}
            />
          ...
          <div class="radio-list">
            <input
              ...
              name="gender"
              value="male"
              onInput={(event) => this.handleRadio(event)}
            />
